...
import KratosXBot.modules.sql.connection_sql as sql
from KratosXBot import DEV_USERS, DRAGONS, dispatcher
from KratosXBot.modules.helper_funcs import chat_status
