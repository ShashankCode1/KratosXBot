...
from KratosXBot import BOT_NAME, BOT_USERNAME, OWNER_ID, telethn
from KratosXBot.events import register
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./KratosXBot/resources/fonts/*")
        ...
        await telethn.send_file(
            event.chat_id,
            file=fname,
            caption=f"Logo generated by [{BOT_NAME}](https://t.me/{BOT_USERNAME})",
        )
        await pesan.delete()
