...
# from KratosXBot.modules.sql import warns_sql as warnssql
import KratosXBot.modules.sql.blacklist_sql as blacklistsql

# from KratosXBot.modules.sql import cust_filters_sql as filtersql
# import KratosXBot.modules.sql.welcome_sql as welcsql
import KratosXBot.modules.sql.locks_sql as locksql
import KratosXBot.modules.sql.notes_sql as sql

# from KratosXBot.modules.rules import get_rules
import KratosXBot.modules.sql.rules_sql as rulessql
from KratosXBot import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from KratosXBot.__main__ import DATA_IMPORT
from KratosXBot.modules.connection import connected
from KratosXBot.modules.helper_funcs.alternate import typing_action
from KratosXBot.modules.helper_funcs.chat_status import user_admin
from KratosXBot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("KratosXBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("KratosXBot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `KratosXBot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("KratosXBot{}.backup".format(chat_id))  # Cleaning file
