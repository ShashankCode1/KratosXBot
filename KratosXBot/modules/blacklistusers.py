...
import KratosXBot.modules.sql.blacklistusers_sql as sql
from KratosXBot import DEMONS, DEV_USERS, DRAGONS, OWNER_ID, TIGERS, WOLVES, dispatcher
from KratosXBot.modules.helper_funcs.chat_status import dev_plus
