...
import KratosXBot.modules.sql.userinfo_sql as sql
from KratosXBot import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
    INFOPIC,
...
from KratosXBot import telethn as KratosTelethonClient
from KratosXBot.__main__ import STATS, TOKEN, USER_INFO
from KratosXBot.modules.disable import DisableAbleCommandHandler
from KratosXBot.modules.helper_funcs.chat_status import sudo_plus
from KratosXBot.modules.helper_funcs.extraction import extract_user
from KratosXBot.modules.sql.afk_sql import check_afk_status, is_afk
from KratosXBot.modules.sql.global_bans_sql import is_user_gbanned
from KratosXBot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        text += "\n\nThis user's disaster level is <b>GOD</b>.\n"
    elif user.id in DEV_USERS:
        text += "\n\nThis user is a member of <b>Kratos Association</b>.\n"
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/KratosXLogs/27"
                            ),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/KratosXLogs/29"
                            ),
                        ],
                    ]
                ),
